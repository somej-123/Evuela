...
if($_SERVER['HTTP_REFERER'] == '' || $_SERVER['HTTP_REFERER'] == null){
    ...
    // 게시판 생성
    $sql = "INSERT INTO evuela_board_comment (comment_id, baord_id, board_category_idx, board_categorytype_idx, comment_contents, board_level, user_id, user_level, createdate)
