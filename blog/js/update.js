...
$(document).ready(() => {
  ...
  $("#mainSection_Body_update_summernote").summernote({
  ...
  $("#summernote_update_btn").on("click", () => {
    ...
    if (user_id == null || user_id == "" || user_id == undefined) {
      ...
      return;
    } else if ($("#mainSection_Body_update_summernote").summernote("isEmpty")) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          // 이미지 태그
          var imgTags = $("#mainSection_Body_updateBody img");
