...
<body>
    ...
    <section id="mainSection">
        ...
        <div id="mainSection_Body" class="container">
            ...
            <div id="mainSection_Body_updateDiv">
                <div id="mainSection_Body_updateHeader">
                    <div id="updateHeader_titleDiv">
                        <input type="text" class="form-control" id="updateHeader_title" aria-describedby="제목을 입력하세요" placeholder="제목을 입력하세요">
                    </div>
                    <div id="updateHeader_categoryDiv">
                        <select id="updateHeader_category" class="form-select" aria-label="Default select example">
                ...
                <div id="mainSection_Body_updateBody">
                    <div id="mainSection_Body_update_summernote"></div>
                </div>
